...
RUNTIME_CONFIG_PAIRS+=("SUGARMAGIC_SUGARAGENT_REGEN_MODEL=${SUGARMAGIC_SUGARAGENT_REGEN_MODEL:-}")
RUNTIME_CONFIG_PAIRS+=("SUGARMAGIC_SUGARAGENT_SUMMARY_MODEL=${SUGARMAGIC_SUGARAGENT_SUMMARY_MODEL:-}")
RUNTIME_CONFIG_PAIRS+=("SUGARMAGIC_SUGARLANG_TARGET_LANGUAGE=${SUGARMAGIC_SUGARLANG_TARGET_LANGUAGE:-}")
